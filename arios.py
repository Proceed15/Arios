...
# Função para criar e tocar o arquivo de áudio
...
while True:
print("Diga algo a ser respondido")
try:
...
if 'fechar inteligência artificial' in mensagem:
...
keyword = grava_youtube(mensagem)
if keyword!= '':
...
# Função para realizar pesquisas na internet
...
# Função principal
def main():
cria_audio('ola.mp3', 'Olá sou sua inteligência artificial Arios, em que posso te ajudar?')
grava_audio()
